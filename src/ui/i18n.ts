...
const DICT: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "te.hint":
      "Arrastra los bogies para colocarlos. Pulsa una caja, un bogie o un fuelle para editar sus parámetros.",
  ...
  fr: {
    ...
    "te.hint":
      "Glissez les bogies pour les positionner. Cliquez une caisse, un bogie ou un soufflet pour éditer ses paramètres.",
    "te.bogie.title": "Bogie",
  ...
  en: {
    ...
    "te.hint":
      "Drag the bogies to position them. Click a car, a bogie or a bellows to edit its parameters.",
    "te.bogie.title": "Bogie",
